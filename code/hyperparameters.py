...
# Use the following formats to add your own models
# (see hyperparameters.py for examples)
...
your_ML_models = {
    "LR_task": {},
    "Direction_task": {"amplitude": {}, "angle": {}},
    "Position_task": {
        "dots": {
            "min": {
                "Lars": [
                    StandardRegressor_2D,
                    {
                        "model_name": "Lars",
                        "fit_intercept": True,
    ...
    "LR_task": {
        "antisaccade": {
            "max": {
                ...
                "DecisionTree": [
                    StandardClassifier_1D,
                    {"model_name": "DecisionTree", "max_depth": 7},
                ],
                "RandomForest": [
                    StandardClassifier_1D,
                    {
    ...
    "LR_task": {
        "antisaccade": {
            "max": {
                "Stratified": [
                    StandardClassifier_1D,
                    {"model_name": "Stratified", "strategy": "stratified"},
                ],
                "MostFrequent": [
                    StandardClassifier_1D,
                    {
                        "model_name": "MostFrequent",
                        "strategy": "most_frequent",
                    },
                ],
                "Prior": [
                    StandardClassifier_1D,
                    {"model_name": "Prior", "strategy": "prior"},
                ],
                "Uniform": [
                    StandardClassifier_1D,
                    {"model_name": "Uniform", "strategy": "uniform"},
                ],
            },
            "min": {
                "Stratified": [
        ...
        "dots": {
            "max": {
                "amplitude": {
                    "Mean": [
                        StandardRegressor_1D,
                        {"model_name": "Mean", "strategy": "mean"},
                    ],
                    "Median": [
                        StandardRegressor_1D,
                        {"model_name": "Median", "strategy": "median"},
                    ],
                },
                "angle": {
                    "Mean": [
    ...
    "Position_task": {
        "dots": {
            "max": {
                ...
                "Constant": [
                    StandardRegressor_2D,
                    {"model_name": "Constant", "strategy": "constant"},
                ],
            },
            "min": {
                "Mean": [
...
if config["include_your_ml_models"]:
    all_models = merge_models(all_models, your_ML_models)
if config["include_your_DL_models"]:
    all_models = merge_models(all_models, your_DL_models)
